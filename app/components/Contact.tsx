        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <a
              ...
              className="group flex items-center gap-5 bg-green-50 hover:bg-green-100 border border-green-100 rounded-2xl p-5 transition-all duration-300 min-h-[72px]"
            >
              ...
              <div>
                ...
                <div className="font-inter text-warm-charcoal/70 text-sm">0542 272 28 93</div>
            ...
            <a
              ...
              className="group flex items-center gap-5 bg-coral-50 hover:bg-coral-100 border border-coral-100 rounded-2xl p-5 transition-all duration-300 min-h-[72px]"
            >
              <div className="w-14 h-14 bg-terracotta-600 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-105 transition-transform duration-300">
              ...
              <div>
                ...
                <div className="font-inter text-warm-charcoal/70 text-sm">0542 272 28 93</div>
                <div className="font-inter text-terracotta-600 text-xs font-medium mt-0.5">Hemen ara →</div>
              </div>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-5 bg-pink-50 hover:bg-pink-100 border border-pink-100 rounded-2xl p-5 transition-all duration-300 min-h-[72px]"
            >
              ...
              <div>
                ...
                <div className="font-inter text-warm-charcoal/70 text-sm">@dytgizemkantar</div>
            ...
            <div className="flex items-start gap-5 bg-warm-white border border-warm-charcoal/5 rounded-2xl p-5">
              ...
              <div>
                ...
                <address className="font-inter text-warm-charcoal/70 text-sm leading-relaxed not-italic">
          ...
          {/* Map — address-based embed without hardcoded placeholder coordinates */}
          <div className="rounded-2xl overflow-hidden shadow-lg border border-warm-charcoal/5 min-h-80 h-full">
            <iframe
              src="https://maps.google.com/maps?q=Sel%C3%A7uklu+Mah.+1455.+Sok.+No:2%2F1+Afyonkarahisar&t=m&z=16&output=embed&hl=tr"
              width="100%"
              height="100%"
              ...
              aria-label="Diyetisyen Armağan Gizem Kantar ofis konumu haritası"
            />
          </div>
        </div>

        {/* Bottom CTA banner */}
        <div className="mt-12 bg-gradient-to-r from-terracotta-600 to-terracotta-700 rounded-3xl p-8 md:p-10 text-center text-white">
          <h3 className="font-poppins font-bold text-2xl md:text-3xl mb-3">
            Sağlıklı yaşama ilk adımı bugün atın
          </h3>
          <p className="font-inter text-white/90 text-sm md:text-base mb-6 max-w-md mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-white text-terracotta-700 hover:bg-coral-50 font-semibold py-3.5 px-6 rounded-full transition-all duration-300 shadow-lg font-poppins text-sm min-h-[44px]"
            >
            ...
            <a
              href="tel:05422722893"
              className="inline-flex items-center justify-center gap-2 bg-white/20 hover:bg-white/30 text-white border border-white/40 font-semibold py-3.5 px-6 rounded-full transition-all duration-300 font-poppins text-sm min-h-[44px]"
            >
              Ara: 0542 272 28 93
            </a>
          </div>
