        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <a
              ...
              className="group flex items-center gap-5 bg-sage-50 hover:bg-sage-100 border border-sage-100 rounded-2xl p-5 transition-all duration-300 min-h-[72px]"
            >
        ...
        <div className="mt-12 bg-gradient-to-r from-sage-500 to-sage-600 rounded-3xl p-8 md:p-10 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-white text-sage-600 hover:bg-sage-50 font-semibold py-3.5 px-6 rounded-full transition-all duration-300 shadow-lg font-poppins text-sm min-h-[44px]"
            >
