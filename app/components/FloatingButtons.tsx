  ...
  return (
    <>
      ...
      >
        ...
        <span className="absolute w-full h-full rounded-full bg-green-500 opacity-30 animate-ping" aria-hidden="true" />
      </a>
      ...
      {showScrollTop && (
        <button
          ...
          className="fixed bottom-24 right-20 z-50 w-10 h-10 bg-white border border-coral-100 text-warm-charcoal rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 hidden md:flex"
        >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden">
        <div className="bg-white/95 backdrop-blur-sm border-t border-warm-charcoal/5 px-4 py-3 flex gap-3">
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-coral-50 text-terracotta-700 border border-coral-200 font-semibold py-3 rounded-xl font-poppins text-sm"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
